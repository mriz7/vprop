...
export default function ValentineProposal() {
  ...
  const memories = [
    ...
    { 
      ...
      date: "Our First Date", 
      caption: "Coffee turned into dinner, dinner turned into walking for hours...", 
      fullStory: "We talked until the restaurant closed. I never wanted that night to end." 
    },
    { 
      id: 3, 
      ...
      fullStory: "Getting lost was the best thing that happened to us that day." 
    },
    { 
      id: 4, 
    ...
    { 
      ...
      fullStory: "You make ordinary days feel extraordinary." 
    },
  ];
